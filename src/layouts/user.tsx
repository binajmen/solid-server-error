...
const leftNavigation = [
  { path: "tests", icon: <i class="fa-solid fa-vial" /> },
  { path: "results", icon: <i class="fa-solid fa-clipboard-list" /> },
];

const rightNavigation = [
  { path: "account", icon: <i class="fa-solid fa-user-gear" /> },
];
